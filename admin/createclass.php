              ...
              <?php 
                while($row=mysqli_fetch_array($table)){
                  ...
                  if(mysqli_num_rows($teacherT) == 1) { 
                    ...
                    <a href=''><button class='btn btn-sm btn-success'><i class='fa fa-circle-o'></i> View</button></a> <a href='data14.php?level=".$row[0]."&sect=".$row[1]."'><button class='btn btn-sm btn-danger'><i class='icon-minus'></i> Delete</button></a>
                    </td></tr>";
                  }
                }
